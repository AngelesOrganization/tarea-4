...
<body>
    ...
    ?>
        ...
        <table>
            ...
            <?php foreach ($autor->libros as $libro) : ?>
                <tr>
                    <td>
                        <a href="<?php echo "http://angeles-fernandez-gomez.duckdns.org/tarea7/cliente.php?action=get_datos_libro&id=" . $libro->id  ?>">
        ...
        <a href="http://angeles-fernandez-gomez.duckdns.org/tarea7/cliente.php?action=get_autores" alt="Lista de autores">Volver a la lista de autores</a>
        <br>
        <a href="http://angeles-fernandez-gomez.duckdns.org/tarea7/cliente.php" alt="Página principal">Volver a la página principal</a>
    <?php
            ...
            <?php foreach ($lista_autores as $autor) : ?>
                <tr>
                    <td>
                        ...
                        <a href="<?php echo "http://angeles-fernandez-gomez.duckdns.org/tarea7/cliente.php?action=get_datos_autor&id=" . $autor->id  ?>">
    ...
    ?>
        ...
        <table class="tabla_corta">
            ...
            <tr>
                <th>Autor</th>
                <td>
                    <a href="<?php echo "http://angeles-fernandez-gomez.duckdns.org/tarea7/cliente.php?action=get_datos_autor&id=" . $libro->autor->id  ?>">
        ...
        <br />
        <!-- Enlace para volver a la lista de autores -->
        <a href="http://angeles-fernandez-gomez.duckdns.org/tarea7/cliente.php?action=get_libros" alt="Lista de libros">Volver a la lista de libros</a>
        <br>
        <a href="http://angeles-fernandez-gomez.duckdns.org/tarea7/cliente.php" alt="Página principal">Volver a la página principal</a>
    <?php
    } else {
    ?>
        <ul>
            <li><a href="<?php echo "http://angeles-fernandez-gomez.duckdns.org/tarea7/cliente.php?action=get_autores" ?>">Ver Autores</a></li>
            <li><a href="<?php echo "http://angeles-fernandez-gomez.duckdns.org/tarea7/cliente.php?action=get_libros" ?>">Ver Libros</a></li>
        </ul>
    <?php
    } ?>
</body>
